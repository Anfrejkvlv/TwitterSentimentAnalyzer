...
public class TwitterSentimentAnalyzer {
    ...
    public static void main(String[] args) {
        TwitterSentimentAnalyzer analyzer = new TwitterSentimentAnalyzer();
        analyzer.initialize();

        try {
            // Load reviews from CSV
            List<String[]> reviews = analyzer.loadReviews("src/main/resources/Microsoft.csv");
    ...
    public void generateReport(Map<String, Integer> sentimentCounts, int totalReviews) {
        System.out.println("\n===Microsoft - Sentiment Analysis Report ===");
